<template>
  ...
  <v-layout row wrap>
    ...
    <v-flex v-for="item in items_int" :key="item.title" xs12 sm6 md4>
      <v-hover>
    ...
    <v-flex v-for="item in items_ext" :key="item.title" xs12 sm6 md4>
      <v-hover>
...
export default {
  data() {
    return {
      ...
      items_ext: [
        { title: 'Viewpoint-dependent Image Projection', image: 'lenticular.jpg', desc: 'Vulkan', link:'http://ishikawa-vision.org/vision/LentiDPM/index-e.html'},
